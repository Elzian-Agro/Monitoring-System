...
function Login({ setPage }) {
  ...
  return (
    <div className="flex-1 flex items-center flex-col lg:justify-center h-full w-full gap-2 xxs:gap-0">
      <h1 className="font-zenkaku font-black text-[#212121] text-[18px] sm:text-[26px] leading-5 sm:leading-10">{t('LOG IN')}</h1>
      <p className="font-zenkaku font-normal text-center text-[#999] text-[10px] sm:text-[16px] leading-5 xxs:leading-10">{t('LOG IN TO YOUR DASHBOARD')}</p>
