    ...
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-secondary-dark-bg p-8 rounded-lg w-96">
      ...
      <div>
        {userProfileData.map((item, index) => (
          <div key={index} className="flex gap-5 border-b-1 border-color p-4 hover:bg-[#F7F7F7] dark:hover:bg-green-400 cursor-pointer">
      ...
      <div className="mt-5">
        <NavLink to="/" className="flex mt-12 items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-black dark:text-white dark:hover:text-black hover:bg-red-500 m-2 duration-300">
