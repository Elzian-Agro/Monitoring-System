...
function SearchBox({ value, onChange, onClick }) {
  return (
    <div className='flex items-center md:justify-center md:mr-2'>
      <div className='flex rounded-lg border border-gray-400'>
        ...
        <input
          type='text'
          className='w-48 sm:w-56 bg-white pl-2 h-8 md:h-10 text-sm lg:text-base outline-0 dark:bg-secondary-dark-bg dark:text-white'
          placeholder=''
          id='searchInput'
          value={value}
          onChange={onChange}
