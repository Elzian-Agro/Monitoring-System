...
const AboutPage = () => {
  ...
  return (
    <div
      className={`flex justify-center items-center bg-gradient-to-br from-green-500 to-lime-500 dark:from-gray-900 dark:to-gray-500 rounded-xl shadow-md px-8 py-20 mx-6 my-4`}>
